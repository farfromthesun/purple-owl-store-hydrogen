...
export type CollectionQuery = {
  collectionBasicInfo?: StorefrontAPI.Maybe<
    Pick<
...
export type CollectionProductsQuery = {
  collectionProducts?: StorefrontAPI.Maybe<{
    products: {
      filters: Array<
        Pick<StorefrontAPI.Filter, 'id' | 'label' | 'type'> & {
          values: Array<
...
export type PageAboutQueryVariables = StorefrontAPI.Exact<{
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
}>;
...
> & {
  ...
  unitPrice?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.MoneyV2, 'amount' | 'currencyCode'>
  >;
  order_limit_metafield?: StorefrontAPI.Maybe<
...
> & {
  ...
  >;
  add_ons_metafield?: StorefrontAPI.Maybe<{
    references?: StorefrontAPI.Maybe<{
      nodes: Array<
        Pick<StorefrontAPI.Product, 'title' | 'id'> & {
