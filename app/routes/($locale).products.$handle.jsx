                    ...
                    >
                      {productData.colors.map((color) => (
                        <Radio
                          ...
                          className={classNames(
                            color.selectedClass,
                            'relative flex cursor-pointer items-center justify-center rounded-full p-0.5 focus:outline-none data-[checked]:ring-2 data-[focus]:data-[checked]:ring data-[focus]:data-[checked]:ring-offset-1',
                          )}
                        >
                          <span
                            aria-hidden="true"
                      ...
                      {productData.sizes.map((size) => (
                        <Radio
                          ...
                          className={classNames(
                            ...
                            'group relative flex items-center justify-center rounded-md border border-gray-200 px-4 py-3 text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none data-[focus]:ring-2 data-[focus]:ring-indigo-500 sm:flex-1 sm:py-6',
                          )}
                        >
                          <span>{size.name}</span>
                          {size.inStock ? (
